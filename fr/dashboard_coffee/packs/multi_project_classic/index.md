...
Lien vers le fichier JSON qu'il est possible de copier directement dans le dashboard : [cliquez ici](http://docs.weelgo.com/fr/dashboard_coffee/packs/multi_project_classic/multi_project_classic_board.json)
